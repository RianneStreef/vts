    ...
    <div>
      <Legal>
        ...
        <p>
          ...
          du site{" "}
          <a href="https:/vts-webdesign.com/">https:/vts-webdesign.com/</a>{" "}
          l'identité des différents intervenants dans le cadre de sa réalisation
          et de son suivi :
        </p>
        <p>
          <strong>Propriétaire</strong> : Rianne Streef - 9007 8380 3000 17 -
          Residence la Saponaire apt 4, 73440 Les Belleville
          <br />
        ...
        <p>
          ...
          <a href="https:/vts-webdesign.com/">https:/vts-webdesign.com/</a> sont
        ...
        <p>
          ...
          décidée par VTS Web Design, qui s’efforcera alors de communiquer
          préalablement aux utilisateurs les dates et heures de l’intervention.
        </p>
        <p>
          Le site{" "}
          <a href="https:/vts-webdesign.com/">https:/vts-webdesign.com/</a> est
          mis à jour régulièrement par Rianne STREEF. De la même façon, les
        ...
        <p>
          Le site{" "}
          <a href="https:/vts-webdesign.com/">https:/vts-webdesign.com/</a> a
          pour objet de fournir une information concernant l’ensemble des
          activités de la société.
        </p>
        <p>
          VTS Web Design s’efforce de fournir sur le site{" "}
          <a href="https:/vts-webdesign.com/">https:/vts-webdesign.com/</a> des
        ...
        <p>
          ...
          <a href="https:/vts-webdesign.com/">https:/vts-webdesign.com/</a> ne
        ...
        <p>
          VTS Web Design est propriétaire des droits de propriété intellectuelle
        ...
        <p>
          VTS Web Design ne pourra être tenue responsable des dommages directs
          et indirects causés au matériel de l’utilisateur, lors de l’accès au
          site https:/vts-webdesign.com/, et résultant soit de l’utilisation
          d’un matériel ne répondant pas aux spécifications indiquées au point
          4, soit de l’apparition d’un bug ou d’une incompatibilité.
        </p>
        <p>
          VTS Web Design ne pourra également être tenue responsable des dommages
        ...
        <p>
          ...
          l’espace contact) sont à la disposition des utilisateurs. VTS Web
          Design se réserve le droit de supprimer, sans mise en demeure
          ...
          relatives à la protection des données. Le cas échéant, VTS Web Design
        ...
        <p>
          ...
          <a href="https:/vts-webdesign.com/">https:/vts-webdesign.com/</a>, le
          fournisseur d'accès de l'utilisateur, l'adresse de protocole Internet
          (IP) de l'utilisateur.
        </p>
        <p>
          {" "}
          En tout état de cause VTS Web Design ne collecte des informations
        ...
        <p>
          ...
          rachat de VTS Web Design et de ses droits permettrait la transmission
        ...
        <p>
          ...
          mis en place avec l’autorisation de VTS Web Design. Cependant, VTS Web
          Design n’a pas la possibilité de vérifier le contenu des sites ainsi
